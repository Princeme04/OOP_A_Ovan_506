...
public class AdminDashboard {
    ...
    public static Scene getScene(Stage stage, String adminName) {
        ...
        itemList.clear();
        itemList.add(new Item("Dompet", "Isinya hilang", "tas tetangga", ItemStatus.reported));
        itemList.add(new Item("baju pdi", "baju megawati", "kamarmandi", ItemStatus.found));
        itemList.add(new Item("Kunci Motor", "Motor bebek", "kasri", ItemStatus.reported));
        itemList.add(new Item("Flashdisk", "gantungan kunci", "Lab Mandi", ItemStatus.claimed));
